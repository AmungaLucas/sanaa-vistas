        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex justify-end">
            <div className="max-w-xl text-right text-white">
              <h1 className="font-poppins font-bold text-2xl md:text-6xl leading-tight mb-4 md:mb-6">
                Sanaa Thru' My Lens
              </h1>
              <p className="font-lora text-sm md:text-xl leading-relaxed mb-6 md:mb-8 text-white/90">
